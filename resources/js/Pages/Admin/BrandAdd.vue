...
const handleSubmit = () => {
  form.post(route('admin.storeBrand'), {
  });
};
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Add Brand</h2>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-7">
                        ...
                        <div class="space-y-12">
                            <div class="border-b border-gray-900/10 pb-12">
                                <h2 class="text-base font-semibold leading-7 text-gray-900">Add Brand</h2>
                                <p class="mt-1 text-sm leading-6 text-gray-600">The added brand data will appear on the customer's page, please fill out the form accordingly.</p>
